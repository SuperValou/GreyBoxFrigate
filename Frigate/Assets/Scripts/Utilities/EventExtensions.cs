...
namespace Assets.Scripts.Utilities
{
    ...
    {
        public static void SafeInvoke<TEventArg>(this Action<TEventArg> eventToInvoke, TEventArg eventArg)
        {
        ...
        public static void SafeInvoke<TEventArg1, TEventArg2>(this Action<TEventArg1, TEventArg2> eventToInvoke,
